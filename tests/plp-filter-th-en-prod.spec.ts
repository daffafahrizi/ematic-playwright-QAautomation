...
// ==========================================
// 3. TARGET URL LIST (DIRECT NAVIGATION LIVE TH-EN)
// ==========================================
const targetPages = [
    ...
    { name: 'Accessories', url: 'https://www.americanstandard.co.th/bathrooms/accessories/' },
    { name: 'Vanities', url: 'https://www.americanstandard.co.th/bathrooms/vanities/' },
    { name: 'Wash Basins', url: 'https://www.americanstandard.co.th/bathrooms/wash-basins/' }
];
...
async function dismissCookies(page: Page) {
    // Included Thai keyword "ยอมรับ" (Accept) just in case
...
// ==========================================
test.describe('PLP Filter Dependencies - Direct URL (Thailand th-en Live)', () => {
