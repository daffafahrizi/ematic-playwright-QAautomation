...
// ==========================================
// 3. TARGET URL LIST (DIRECT NAVIGATION STAGING MM-EN)
// ==========================================
const targetPages = [
    { name: 'Commercial', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/commercial/' },
    { name: 'Bathtubs', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/bathtubs/' },
    { name: 'Bath & Showers', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/bath-and-showers/' },
    { name: 'Basin Faucets', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/basin-faucets/' },
    { name: 'Spalets', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/spalets/' },
    { name: 'Toilets', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/toilets/' },
    { name: 'Accessories', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/accessories/' },
    { name: 'Vanities', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/vanities/' },
    { name: 'Wash Basins', url: 'https://mm.47.130.209.149.nip.io/en/bathrooms/wash-basins/' }
];
...
// ==========================================
test.describe('PLP Filter Dependencies - Direct URL (Myanmar mm-en Staging)', () => {
