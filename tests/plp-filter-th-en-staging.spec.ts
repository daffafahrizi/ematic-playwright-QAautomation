...
// ==========================================
// 3. TARGET URL LIST (DIRECT NAVIGATION STAGING TH-EN)
// ==========================================
const targetPages = [
    { name: 'Commercial', url: 'https://th.47.130.209.149.nip.io/bathrooms/commercial/' },
    { name: 'Bathtubs', url: 'https://th.47.130.209.149.nip.io/bathrooms/bathtubs/' },
    { name: 'Bath & Showers', url: 'https://th.47.130.209.149.nip.io/bathrooms/bath-showers/' },
    { name: 'Basin Faucets', url: 'https://th.47.130.209.149.nip.io/bathrooms/basin-faucets/' },
    { name: 'Spalets', url: 'https://th.47.130.209.149.nip.io/bathrooms/spalets/' },
    { name: 'Toilets', url: 'https://th.47.130.209.149.nip.io/bathrooms/toilets/' },
    { name: 'Accessories', url: 'https://th.47.130.209.149.nip.io/bathrooms/accessories/' },
    { name: 'Vanities', url: 'https://th.47.130.209.149.nip.io/bathrooms/vanities/' },
    { name: 'Wash Basins', url: 'https://th.47.130.209.149.nip.io/bathrooms/wash-basins/' }
];
...
async function dismissCookies(page: Page) {
    // Included Thai keyword "ยอมรับ" (Accept) just in case the banner shows up in local language
...
// ==========================================
test.describe('PLP Filter Dependencies - Direct URL (Thailand th-en Staging)', () => {
